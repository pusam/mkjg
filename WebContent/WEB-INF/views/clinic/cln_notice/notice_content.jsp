...
<link rel="apple-touch-icon-precomposed"
	...
	<style type="text/css">
		#subejct{background-color: #F5F5F5; height: 25px;}
		#writer{background-color: #F5F5F5; height: 25px;}
      ...
      <div class="row">
        <div class="span12">
         <div class="page-header">
          ...
          <tr>
          	<td >
                <input class="input-xxlarge" type="text" placeholder="제목" id="subject" name="subject" readonly="readonly" value="${view.ntitle}">
                <br/><br/>
            </td>
          </tr>
           <tr>
          	<td>
                <input class="input-xxlarge" type="text" placeholder="작성자" id="writer" name="writer" readonly="readonly" value="${view.aid}">
                <br/><br/>
           </td>
           </tr>
           <tr>
          	<td>
                <input class="input-xxlarge" type="text" placeholder="날짜" id="date" name="date" readonly="readonly" value="${view.reg_date}">
                <br/><br/>
           </td>
           </tr>
          <tr>
          	<td>
                <textarea name="content" rows="15" cols="35" maxlength="1000" style="width: 530px;" id="content" placeholder="공지사항 내용">${view.ntext}</textarea>
                <br/><br/><br/>
           </td>
          </tr>
             <tr>
          	<td>
                <input type="hidden"  id="seq" name="not_seq" readonly="readonly" value="${view.not_seq}">
                <br/><br/>
           </td>
               </table>
