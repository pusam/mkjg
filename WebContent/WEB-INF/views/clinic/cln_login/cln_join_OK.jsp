      ...
      <div class="row">
        ...
        <div class="span8">
          <ul class="breadcrumb notop">
            ...
            <li class="active">업체등록<span class="divider">/</span></li>
            <li class="active">성공</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="span12">
          <div class="centered">
            ...
            <h1><strong>회원 가입이 완료되었습니다.</strong></h1>
                <div style="text-align: center;" >
            	<a href="index_cln.do"><button type="button" class="btn btn-large btn-color" id="home">HOME</button></a>
            	<br/>
             </div>
          </div>
        </div>
