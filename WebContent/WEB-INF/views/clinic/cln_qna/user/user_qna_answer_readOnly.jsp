 ...
 <div class="container">
     ...
     <div class="span12">
		 <section id="tables" class="doc">
            ...
            <c:forEach var="uqro" items="${user_qna_read_only}">
            	<tr>
            		<th>${uqro.pid}님의 문의 내역</th>
            	</tr>
            	<tr>
            		<td>문의 타입 : ${uqro.qtype}</td>
            	</tr>
            	<tr>
            		<td>문의 일시 : ${uqro.qdate}</td>
            	</tr>
            	<tr>
            		<td>제목 : ${uqro.qtitle}</td>
            	</tr>
            	<tr>
            ...
            <table style="border: 1px solid #333; width: 500px;">
            	...
            	<tr>
            		<td>답변일시 : ${uqro.rdate }</td>
            	</tr>
            	<tr>
            		<td>
            			<textarea rows="8" cols="40" style="width: 500px" id="text" name="text" readonly="readonly">
            			${uqro.reply}
            			</textarea>
            		</td>
            	</tr>
            	<tr>
            		<td><input type="button" value="목록보기" id="btnList" style="float: right;" class="btn btn-inverse"></td>
            	</tr>
            </table>
            </c:forEach>
            </div>
