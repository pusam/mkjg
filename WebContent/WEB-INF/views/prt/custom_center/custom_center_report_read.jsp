...
#report_read{margin-left:350px;margin-top:70px;}
    ...
    <body>
        <div id="page">
            ...
            <section class="blog">
                <div class="container">
                    <div class="row">
                    	<div id="sub_title_top"><img src="http://211.63.89.152/mkjg/common/prt/images/mini_home.png" style="margin-bottom:3px;"/> &gt; 고객센터 &gt; 신고하기 &gt; 신고확인</div>
						...
						<form id="frm" method="get">
							...
							<tr>
								...
								<td style="border-top:2px solid #FF4157;"><input type="text" style="width:200px;margin-left:5px;" readonly="readonly"/></td>
							...
							<tr>
								<th>작성일</th>
								<td><input type="date" style="width:130px;margin-left:5px;" readonly="readonly"/></td>
								<th>전화번호</th>
								<td><input type="text" style="width:150px;margin-left:5px;" readonly="readonly" title="병원 연락처를 입력해주세요."/></td>
							</tr>
							<tr>
								<th>제목</th>
								<td colspan="3"><input type="text" style="width:433px;margin-left:5px;" readonly="readonly"/></td>
							</tr>
							<tr>
								<th style="vertical-align:top;">내용</th>
								<td colspan="3">
									<textarea rows="10" cols="59" style="margin-left:5px;">내용을 입력해주세요.</textarea>
								</td>
							</tr>
							<tr>
								<th style="vertical-align:top;">신고답변</th>
								<td colspan="3">
									<textarea rows="10" cols="59" style="margin-left:5px;" readonly="readonly">답변이 아직 없습니다.</textarea>
								</td>
							</tr>
							<tr>
