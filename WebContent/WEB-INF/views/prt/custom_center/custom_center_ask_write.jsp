...
function doChange(srcQ, targetId){
    var val = srcQ.options[srcQ.selectedIndex].value;
    var targetQ = document.getElementById(targetId);
    removeAll(targetQ);

    if(val == 'question_gc'){
        addOption('진료문의', targetQ);
        addOption('날짜문의', targetQ);
        addOption('상품문의', targetQ);
        addOption('기타문의', targetQ);
    }
    else if(val == 'question_ua'){
        addOption('홈페이지문의', targetQ);
        addOption('오류문의', targetQ);
        addOption('등록문의', targetQ);
        addOption('기타문의', targetQ);
    }
}
...
#ask_write{margin-left:350px;margin-top:70px;}
...
#btnAsk{width:70px;height:30px;font-family:'Ubuntu'; font-size:13px;background-color:#F2F2EF; border:1px solid #ccc;}
#btnCancel{width:70px;height:30px;font-family:'Ubuntu'; font-size:13px;background-color:#F2F2EF; border:1px solid #ccc;}
</style>
    </head>
    <body>
        <div id="page">
            ...
            <section class="blog">
                <div class="container">
                    <div class="row">
                    	<div id="sub_title_top"><img src="http://211.63.89.152/mkjg/common/prt/images/mini_home.png" style="margin-bottom:3px;"/> &gt; 고객센터 &gt; 문의하기 &gt; 문의접수</div>
							...
							<table id="tab">
								<tr>
									...
									<td style="border-top:2px solid #FF4157;">
										<select name="selQuestion" id="selQuestion" onchange="doChange(this, 'selSub')" style="height:23px;margin-left:5px;">
											<option value="default">--------------</option>
											<option value="question_gc">병원문의</option>
											<option value="question_ua">관리자문의</option>
										</select>
										<select name="selSub" id="selSub" style="height:23px;">
								...
								<tr>
									<th>병원명</th>
									<td><input type="text" style="width:150px;margin-left:5px;"/></td>
								</tr>
								<tr>
									<th>작성일</th>
									<td><input type="date" style="width:150px;margin-left:5px;" readonly="readonly" value='<fmt:formatDate value="<%=new Date() %>" pattern="yyyy-MM-dd" />'/></td>
								</tr>
								<tr>
									<th>제목</th>
								...
								<tr>
									...
									<td>
										<textarea rows="20" cols="54" style="margin-left:5px;">내용을 입력해주세요.</textarea>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="text-align:center; height:50px;">
										<input type="button" id="btnAsk" value="문의하기"/>
										<input type="button" id="btnCancel" value="취소하기"/>
									</td>
								</tr>
							</table>
						</form>
