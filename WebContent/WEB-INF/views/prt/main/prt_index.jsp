        ...
        <div id="page">
            ...
            <div id="myCarousel1" class="carousel slide" data-ride="carousel"> 
                ...
                <div class="carousel-inner">
                    <div class="item active"> <img src="http://localhost:8080/mkjg/common/prt/images/prt/intro_banner1.png" style="width:100%; height: 500px" alt="First slide">
                        <div class="carousel-caption">
                        </div>
                    </div>
                    <div class="item"> <img src="http://localhost:8080/mkjg/common/prt/images/prt/intro_banner2.png" style="width:100%; height: 500px" alt="Second slide">
                        <div class="carousel-caption">
                        </div>
                    </div>
                    <div class="item"> <img src="http://localhost:8080/mkjg/common/prt/images/prt/intro_banner3.png" style="width:100%; height: 500px" alt="Third slide">
                        <div class="carousel-caption">
                        </div>
                    </div>

                </div>
                <a class="left carousel-control" href="#myCarousel1" data-slide="prev"> <img src="http://localhost:8080/mkjg/common/prt/images/icons/left-arrow.png" onmouseover="this.src = 'http://localhost:8080/mkjg/common/prt/images/icons/left-arrow-hover.png'" onmouseout="this.src = 'http://localhost:8080/mkjg/common/prt/images/icons/left-arrow.png'" alt="left"></a>
                <a class="right carousel-control" href="#myCarousel1" data-slide="next"><img src="http://localhost:8080/mkjg/common/prt/images/icons/right-arrow.png" onmouseover="this.src = 'http://localhost:8080/mkjg/common/prt/images/icons/right-arrow-hover.png'" onmouseout="this.src = 'http://localhost:8080/mkjg/common/prt/images/icons/right-arrow.png'" alt="left"></a>
            ...
            <section class="resort-overview-block">
                <div class="container" style="5px solid #333;">
					...
					<option value="${ list.bln }"><c:out value="[${ list.sido } ${ list.sigungu }] ${ list.cln_name }" />
                                    ...
                                    <div class="links"><a href="http://localhost:8080/mkjg/cln_night.do">더보기</a></div>
                                </div>
                            </div>
                            <div class="side-B">
                                <div class="product-desc-side">
					...
					<option value="${ list.bln }"><c:out value="[${ list.sido } ${ list.sigungu }] ${ list.cln_name }" />
                                    ...
                                    <div class="links"><a href="http://localhost:8080/mkjg/cln_all.do">더보기</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="clear"></div>
					...
					<option value="${ list.not_seq }"><c:out value="${ list.ntitle }" />
                                    ...
                                    <div class="links"><a href="http://localhost:8080/mkjg/prt_notice.do">더보기</a></div>
                                </div>
                            </div>
                            <div class="side-B">
                                <div class="product-thumb">
                                    <div class="image txt-rgt">
                                        <a class="arrow-left"><img src="http://localhost:8080/mkjg/common/prt/images/prt/slide3.png" style="height:250px; margin-left:50px;" class="img-responsive" alt="imaga"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
