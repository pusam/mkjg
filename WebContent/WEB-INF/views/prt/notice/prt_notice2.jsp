...
<html lang="ko">
   ...
   $(function(){
		...
		$("#notice_num").click(function() {
			var notice_num=$("#num").val();
			if(notice_num!="none"){
				$.ajax({
					url:"notice_read.do",
   ...
   <style type="text/css">
    th{border-bottom: 1px solid #B0B9B8;height: 28px; background-color: #F2F2EF;color: #656565}		
	td{border-bottom: 1px solid #B0B9B8;text-align: center; height:25px;}		
	tr:hover{background-color: #FFF7F7;} 	
	...
	#cntTitle{width: 60px; text-align: center;}	
   </style>
    </head>
    <body>
        <div id="page">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-6 col-xs-6">
                                <div id="logo">
                                    ...
                                    <a href="prt_index.do"><img src="http://211.63.89.152/mkjg/common/prt/images/icons/picon.png" width="50"/><span style="font-size:45px;">MKJG</span></a>
                                </div>                       
                            </div>
            ...
            <!--end-->
            <section class="image-head-wrapper" style="background-image: url('http://211.63.89.152/mkjg/common/prt/images/banner2.png');">
		...
		<table id="tab" style="margin:0px auto; float:center;">
			<thead>
			<tr>
	...
	<c:forEach var="notice" items="${ notice_list }">
		<input type="hidden" id="num" value="${ notice.not_seq }"/>
			<c:set var="cnt" value="${ cnt-1 }"/>
		<tr>
			<td><c:out value="${ cnt }"/></td>
			<td class="title" id="notice_num"><a href="notice_read.do?notice_num=${ notice.not_seq }"><c:out value="${ notice.ntitle }"/></a></td>
			...
			<td><c:out value="${ notice.reg_date }"/></td>
						...
						<div id="indexList" style="text-align: center;"><a href="prt_notice.do">&lt;</a>
