...
$(function(){
	...
	$("#btnMonitor").click(function(){
		location.href="mypage_monitor_chk.do";		
	});
...
#tab{/* border:1px solid #ccc; */border-spacing:0px;width:735px;}
...
#btnDetailChk{width:100px;height:30px;font-family:'Ubuntu'; font-size:13px;background-color:#F2F2EF; border:1px solid #ccc;margin:0px auto;}
...
#btnReport{width:70px;height:30px;font-family:'Ubuntu'; font-size:13px;background-color:#F2F2EF; border:1px solid #ccc;margin:0px auto;margin-left:10px;}
                    ...
                    <div class="row">
						...
						<form id="frm" method="get" action="custom_center_ask_write.jsp"> 
							<table id="tab">
								...
								<tr>
									<th id="checkTitle" style="width:40px;"><input type="checkbox" disabled="disabled"/></th>
									<th id="numTitle" style="width:80px;">번호</th>
									<th id="AnimalTitle" style="width:115px;">동물종류</th>
									<th id="AnimalNameTitle" style="width:120px;">동물명</th>
									<th id="MsgTitle" style="width:115px;">케어메세지</th>
									<th id="clnlName" style="width:160px;">병원명</th>
								...
								<tr>
									...
									<td><a href="custom_center_ask_read.jsp">고양이</a></td>
									<td>러시안블루</td>
									<td><a href="#">메세지읽기</a></td>
									<td>청담우리동물병원</td>
									<td>2018-08-28</td>
								</tr>
								<tr>
									<td><input type="checkbox"/></td>
									<td style="text-align:center">1</td>
									<td><a href="custom_center_ask_read.jsp">강아지</a></td>
									<td>포메라니안</td>
									<td><a href="#">메세지읽기</a></td>
									<td>청담우리동물병원</td>
									<td>2018-08-30</td>
								...
								<tr>
									<td colspan="8" style="height:50px;">
										<input type="button" id="btnDetailChk" value="상세진단확인"/>
										<input type="button" id="btnMonitor" value="모니터링"/>
										<input type="button" id="btnReport" value="신고하기"/>
									</td>
								</tr>
								<tr>
									<td colspan="8" style="border-top:1px solid white;">
									<br/>
									<div id="indexList">
