...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="http://211.63.89.152/mkjg/common/prt/images/icons/icon1.png"/>
        <title>맡겨주개</title>
    ...
    <body>
        <div id="page">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-6">
                                <div id="logo">
                                    <!--<a href="index.html"><img src="images/logo.png" alt="logo"></a>-->
                                     <a href="index.do"><img src="http://211.63.89.152/mkjg/common/prt/images/icons/cicon.png"/><span style="font-size:40px;">MKJG</span></a>
                                </div>                       
                            </div>
            ...
            <section class="blog">
                <div class="container">
                    <div class="row">
                    	<div id="sub_title_top"><img src="http://211.63.89.152/mkjg/common/prt/images/mini_home.png" style="margin-bottom:3px;"/> &gt; 마이페이지 &gt; 블랙리스트</div>
                    	<div id="sub_title"><div id="move_title"><img src="http://211.63.89.152/mkjg/common/prt/images/icons/blacklist.png" style="width:45px;"/>&nbsp; 블랙리스트</div></div>
                     	<div id="mypage">
