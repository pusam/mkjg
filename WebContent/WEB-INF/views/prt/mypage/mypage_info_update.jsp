    ...
    <body>
        <div id="page">
            ...
            <section class="blog">
                <div class="container">
                    <div class="row">
                    	<div id="sub_title_top"><img src="http://localhost:8080/mkjg/common/prt/images/mini_home.png" style="margin-bottom:3px;"/> &gt; 마이페이지 &gt; 정보변경</div>
                    	<div id="sub_title"><div id="move_title"><img src="http://localhost:8080/mkjg/common/prt/images/icons/info_update.png" style="width:45px;"/>&nbsp; 정보변경</div></div>
                     	<div id="mypage">
						<form id="frm" method="get" action="custom_center_ask_write.jsp"> 
							<table id="tab">
								<tbody>
									...
									<tr>
										<th><img src="http://localhost:8080/mkjg/common/prt/images/icons/check.png" style="width:20px;"/> 비밀번호</th>
										<td><input type="password" id="pwd" name="pwd"/></td>
									</tr>									
									<tr>
										<th><img src="http://localhost:8080/mkjg/common/prt/images/icons/check.png" style="width:20px;"/> 비밀번호 확인</th>
