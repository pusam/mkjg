...
<html lang="ko">
    ...
    <style type="text/css">
    	...
    	#cln_review_tab{width:450px; text-align: center; float:center; margin:0px auto; border:1px solid #333;}
    	...
    	td{padding:5px; border:1px solid #333; text-align: left; margin-top:3px;}
            ...
            <section class="resort-overview-block">
                <div class="container">
					...
					<div id="clinic_content">
						...
						<table id="cln_review_tab">
							<tr>
								<td>
								작성자<br/>
								작성일<br/>
								<img src="http://localhost:8080/mkjg/common/prt/images/prt/star4.png"/><br/><br/>
								리뷰내용1
								</td>
							</tr>
							<tr>
								...
								작성자<br/>
								작성일<br/>
								<img src="http://localhost:8080/mkjg/common/prt/images/prt/star5.png"/><br/><br/>
								리뷰내용2
								</td>
							</tr>
							<tr>
								...
								작성자<br/>
								작성일<br/>
								<img src="http://localhost:8080/mkjg/common/prt/images/prt/star2.png"/><br/><br/>
								리뷰내용3
								</td>
							</tr>
							<tr>
								...
								작성자<br/>
								작성일<br/>
								<img src="http://localhost:8080/mkjg/common/prt/images/prt/star3.png"/><br/><br/>
								리뷰내용4
								</td>
							</tr>
							</table>
						...
						<div>
						<a href="cln_review_write.do"><input type="button" id="reviewbtn" value="리뷰작성하기" class="btn"/></a>
						</div>
