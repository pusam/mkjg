                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-6 col-xs-6">
                                <div id="logo">
                                    ...
                                    <a href="prt_index.do"><img src="http://localhost:8080/mkjg/common/prt/images/icons/icon.png" width="50"/><span style="font-size:45px;">MKJG</span></a>
                                </div>                       
                            </div>
                ...
                <div class="container">
					...
					<div id="clinic_content">
						...
						<table id="cln_review_write_top">
							...
							<tr>
								<td>별점<br/>
								<img src="http://localhost:8080/mkjg/common/prt/images/prt/star4.png"/>
								</td>
							</tr>
						</table>
