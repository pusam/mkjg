...
<html lang="ko">
    ...
    <style type="text/css">
    	...
    	#cln_ask{width:450px; height:380px; text-align: left; text-valign:top; float:center; margin:0px auto; border:1px solid #333;}
